...
user=${DB_USER}:password=${DB_PASSWORD}:serverName=${DB_HOST}:port
Number=${DB_PORT}:databaseName=${DB_NAME}:sslmode=${DB_SSL_MODE}
PostgresPool
...
--postbootcommandfile
/opt/payara/config/post-boot-generated.asadmin \
